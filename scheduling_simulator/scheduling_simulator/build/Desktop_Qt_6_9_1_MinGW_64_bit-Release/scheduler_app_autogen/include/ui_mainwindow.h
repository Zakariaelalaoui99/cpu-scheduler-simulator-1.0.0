...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, labelArrival);

        arrivalEdit = new QLineEdit(groupBox_2);
        arrivalEdit->setObjectName("arrivalEdit");

        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, arrivalEdit);

        labelBurst = new QLabel(groupBox_2);
        labelBurst->setObjectName("labelBurst");

        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, labelBurst);

        burstEdit = new QLineEdit(groupBox_2);
        burstEdit->setObjectName("burstEdit");

        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, burstEdit);
        ...
        formLayout->setWidget(3, QFormLayout::ItemRole::LabelRole, addButton);

        labelAlg = new QLabel(groupBox_2);
        labelAlg->setObjectName("labelAlg");

        formLayout->setWidget(4, QFormLayout::ItemRole::LabelRole, labelAlg);

        algorithmBox = new QComboBox(groupBox_2);
        algorithmBox->setObjectName("algorithmBox");

        formLayout->setWidget(4, QFormLayout::ItemRole::FieldRole, algorithmBox);

        labelQuantum = new QLabel(groupBox_2);
        labelQuantum->setObjectName("labelQuantum");

        formLayout->setWidget(5, QFormLayout::ItemRole::LabelRole, labelQuantum);
        ...
        formLayout->setWidget(5, QFormLayout::ItemRole::FieldRole, quantumSpin);

        labelMode = new QLabel(groupBox_2);
        labelMode->setObjectName("labelMode");

        formLayout->setWidget(6, QFormLayout::ItemRole::LabelRole, labelMode);

        modeBox = new QComboBox(groupBox_2);
        modeBox->setObjectName("modeBox");

        formLayout->setWidget(6, QFormLayout::ItemRole::FieldRole, modeBox);

        labelTQ = new QLabel(groupBox_2);
        labelTQ->setObjectName("labelTQ");

        formLayout->setWidget(7, QFormLayout::ItemRole::LabelRole, labelTQ);
        ...
        formLayout->setWidget(7, QFormLayout::ItemRole::FieldRole, threadQuantumSpin);

        labelCS = new QLabel(groupBox_2);
        labelCS->setObjectName("labelCS");

        formLayout->setWidget(8, QFormLayout::ItemRole::LabelRole, labelCS);
        ...
        formLayout->setWidget(8, QFormLayout::ItemRole::FieldRole, contextSwitchSpin);

        startButton = new QPushButton(groupBox_2);
        startButton->setObjectName("startButton");

        formLayout->setWidget(9, QFormLayout::ItemRole::LabelRole, startButton);

        resetButton = new QPushButton(groupBox_2);
        resetButton->setObjectName("resetButton");

        formLayout->setWidget(9, QFormLayout::ItemRole::FieldRole, resetButton);
